...
def helm_values(request):
    """By default use "helm/portal-frontend/linter_values.yaml"."""
    default_values = ["helm/portal-frontend/linter_values.yaml"]
...
def chart_path(pytestconfig):
    ...
    if not chart_path:
        ...
        chart_path = os.path.normpath(
            os.path.join(tests_path, "../../../helm/portal-frontend"),
        )
    return chart_path
