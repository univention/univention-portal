...
class TestPortalServerUsesObjectStorageAccessKeyViaEnv(SettingsTestObjectStorageSecret, AuthPasswordUsageViaEnv):
    sub_path_env_password = "env[?@name=='OBJECT_STORAGE_ACCESS_KEY_ID']"
    secret_default_key = "access_key_id"


class TestPortalServerUsesObjectStorageSecretAccessKeyViaEnv(SettingsTestObjectStorageSecret, AuthPasswordUsageViaEnv):
