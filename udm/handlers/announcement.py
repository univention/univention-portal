...
long_description = _('One folder in https://fqdn/univention/portal which holds one or more portals/announcement objects. Belongs to one or more portals/portal objects')
options = {
...
property_descriptions = {
	...
	'needsConfirmation': univention.admin.property(
		...
		long_description=_('If true, the user will see a "Confirm" button and the announcement will persist until it is clicked.'),
	...
	'isSticky': univention.admin.property(
		...
		long_description=_('If true, the announcement can\'t be closed and will persist until the time ends (or never).'),
		syntax=univention.admin.syntax.TrueFalseUp,
		default='FALSE',
		dontsearch=True,
		required=False,
