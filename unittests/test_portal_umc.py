    ...
    expected_entries = [
        {
            ...
            "linkTarget": "embedded",
            "links": [{"locale": "en_US", "value": "/univention/management/?header=try-hide&overview=false&menu=false#module=udm:portals/all"}],
            "icon_url": None,
            "name": {"en_US": "Portal"},
            "target": None,
        }
...
@pytest.mark.parametrize("umc_check_icons_setting,expected", [(True, None), (False, "/univention/management/js/dijit/themes/umc/icons/scalable/portal.svg")])
def test_get_entries_returns_icon_url_without_check(umc_check_icons_setting, expected, mock_portal_config, portal_umc, stub_visible_content):
...
def test_module_icon_url_checks_correct_file_path(mocker, portal_umc, umc_modules_data):
    ...
    expected_icon_filename = "/usr/share/univention-management-console-frontend/js/dijit/themes/umc/icons/scalable/portal.svg"
